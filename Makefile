...
# Source files
SRC_DIR = src
SRCS_C = $(SRC_DIR)/main.c $(SRC_DIR)/uart.c $(SRC_DIR)/bootloader.c $(SRC_DIR)/dtbParser.c $(SRC_DIR)/helper.c $(SRC_DIR)/initrd.c $(SRC_DIR)/sbi.c $(SRC_DIR)/buddy.c $(SRC_DIR)/kmalloc.c $(SRC_DIR)/startup_alloc.c $(SRC_DIR)/trap.c $(SRC_DIR)/timer.c $(SRC_DIR)/task.c $(SRC_DIR)/thread.c $(SRC_DIR)/process.c $(SRC_DIR)/signal.c $(SRC_DIR)/mmap.c $(SRC_DIR)/syscall.c $(SRC_DIR)/framebuffer.c $(SRC_DIR)/vm.c $(SRC_DIR)/vfs.c $(SRC_DIR)/tmpfs.c $(SRC_DIR)/ramfs.c $(SRC_DIR)/devfs.c
